      ...
      <div className="personal-info" style={{ "--order": 2 }}>
        ...
        <ul className=" about-ul">
          <li class="list-group-item">
            Completed my degree in computerScience from st.josephs Degree and pg
            college with 8.4 Gpa in 2022
          </li>
          <li class="list-group-item">
            completed My inter graduation in MPC from Vishwabharathi Jr.College
            with 780 Marks
          </li>
          <li class="list-group-item">
