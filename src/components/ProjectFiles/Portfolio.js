  ...
  return (
    <>
      ...
      <div className="project-details-cont">
        <h1 className="project-details-heading">Portfolio Website</h1>
        <p className="project-details-para">This is my second project.</p>
        <h4 className="project-details-heading">Theme : </h4>
        <p className="project-details-para">
          This is my personal website where all my projects and skill will be
          stored. There is no backend as the info is manually entered
        </p>
